...
(key-chord-define ruby-mode-map "je" 'my/ruby-tags)
#+END_SRC

#+BEGIN_SRC emacs-lisp
(defun my/pop-mark ()
  "Pop etag mark or go to last edit."
  (interactive)
  (unless (ignore-errors (or (pop-tag-mark) t))
    (goto-last-change 1)))
(key-chord-define-global "jb" 'my/pop-mark)
...
(key-chord-define-global "jf" 'helm-recentf)
#+END_SRC
** Hydra
#+BEGIN_SRC emacs-lisp
...
(defhydra hydra/ruby ()
  "Ruby"
  ("s" my/specs "RSpec" :exit t)
  ("r" rake "Rake" :exit t)
  ("c" rubocop-check-current-file "Rubocop" :exit t)
  ("y" yari "Ri" :exit t)
  ("t" my/ruby-tags "TAG" :exit t))

(key-chord-define ruby-mode-map "ii" 'hydra/ruby/body)
#+END_SRC
...
(defhydra hydra/window ()
  "Window"
  ("o" ace-select-window "Switch" :exit t)
