...
(defhydra hydra/main ()
  ...
  ("f" (my/nav-to-hydra 'helm-projectile-find-file-in-known-projects) "File" :exit t)
  ("b" (my/nav-to-hydra 'helm-multi-files) "Buffer" :exit t)
  ("T" beginning-of-buffer "Top")
  ("B" end-of-buffer "Bottom")
  ("e" hydra/edit/body "Edit" :exit t)
  ("w" hydra/window/body "Window" :exit t)
  ("m" helm-M-x "Command")
  ("q" keyboard-quit "Quit" :exit t))
(key-chord-define-global "kk" 'hydra/main/body)

(defhydra hydra/projectile ()
  "Projectile"
  ("p" (my/nav-to-hydra 'helm-projectile-switch-project) "Project" :exit t)
  ("f" (my/nav-to-hydra 'helm-projectile-find-file) "File" :exit t))

(defhydra hydra/window ()
  "Window"
  ("o" ace-window "Switch")
  ("1" delete-other-windows "Focus")
...
Navigate to a buffer and present options via =hydra/edit=.

#+BEGIN_SRC emacs-lisp
(defun my/nav-to-hydra (expr)
  "Execute EXPR then open hydra/edit/body."
  (progn
    (funcall expr)
    (hydra/edit/body)))
...
(defhydra hydra/edit ()
  ...
  ("u" undo "Undo")
  ("r" diff-undo "Redo")
  ("M" magit-status "Git" :exit t)
  ("g" helm-etags-select "Goto")
  ("1" delete-other-windows "Focus")
  ("q" keyboard-quit "Quit" :exit t))
#+END_SRC
...
Undo last edit and present options via =hydra/edit=.
