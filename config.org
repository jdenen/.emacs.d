...
(defhydra hydra/menu ()
  "Menu"
  ("m" helm-M-x "Command")
  ("p" hydra/projectile/body "Project" :exit t)
  ("f" find-file "File")
  ("t" my/bash "Terminal" :exit t)
  ("w" hydra/windmove/body "Window" :exit t)
  ("q" nil "Quit" :exit t))
...
(defhydra hydra/projectile ()
  ...
  ("j" helm-etags-select "Tag" :exit t)
  ("v" projectile-vc "VC" :exit t)
  ("k" hydra/menu/body "Menu" :exit t)
  ("q" nil "Quit" exit: t))
...
#+BEGIN_SRC emacs-lisp
(key-chord-define-global "kk" 'hydra/menu/body)
#+END_SRC
** Version Control
#+BEGIN_SRC emacs-lisp
;;; Git
